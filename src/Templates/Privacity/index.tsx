    ...
    <>
      <Container>
        <Separator>
          ...
          <p>
            A sua privacidade é importante para nós. É política do Vibrágua
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site Vibrágua, e outros sites que possuímos e
            operamos. <br /> <br />
            Solicitamos informações pessoais apenas quando realmente precisamos
            delas para lhe fornecer um serviço. Fazemo-lo por meios justos e
            legais, com o seu conhecimento e consentimento. Também informamos
            por que estamos coletando e como será usado. <br /> <br />
            ...
            <br /> <br />O nosso site pode ter links para sites externos que não
            são operados por nós. Esteja ciente de que não temos controle sobre
            ...
            serviços desejados. <br /> <br />O uso continuado de nosso site será
        ...
        <Separator>
          <h2>Política de Cookies Vibrágua</h2>
          <p>
        ...
        <Separator>
          <p>
            Esta política é efetiva a partir de <strong>Julho/2021.</strong>
          </p>
        </Separator>
      </Container>
    </>
